...
class TicketService:
    ...
    current_user_id: str,           # FIX: int → str (UUID)
    current_user_role: str,         # FIX: added missing parameter
) -> Ticket:
    ...
    async def get_ticket_detail(
        ...
        if role == UserRole.USER and ticket.customer_id != current_user_id:
    ...
    async def assign_ticket(
        ...
        if role == UserRole.SUPPORT_AGENT and new_assignee != current_user_id:
            raise InsufficientPermissionsError(
