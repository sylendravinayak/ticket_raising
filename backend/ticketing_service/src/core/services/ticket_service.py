...
class TicketService:
    ...
    async def transition_status(
        ...
        if new_status == TicketStatus.ON_HOLD:
            ...
            # Resume: accumulate hold time, push resolution deadline forward
            if ticket.hold_started_at:
                ...
                ticket.resolution_due_at = (
                    ...
                    else now + timedelta(minutes=settings.DEFAULT_RESOLUTION_TIME_MINUTES)
                )
            ...
            deadlines = await self._sla_svc.recalculate_for_reopen(
                customer_tier_id=ticket.customer_tier_id,
    ...
    async def get_my_tickets(
        ...
        return await self._ticket_repo.list_for_customer(current_user_id, filters)
